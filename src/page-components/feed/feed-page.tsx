              ...
              <div className="pt-3">
                {!isSubscribed ? (
                  <Button
                    ...
                    className="rounded-xl font-bold bg-blue-600 hover:bg-blue-700 text-white shadow-md transition-all hover:scale-105 active:scale-95"
                  >
                    {isPushLoading ? (
                  ...
                  <Button
                    ...
                    onClick={() => unsubscribe()}
                    disabled={isPushLoading}
                    className="rounded-xl font-bold border-border/60 shadow-sm transition-all hover:scale-105 active:scale-95"
                  >
                    {isPushLoading ? (
                      <Loader2 className="h-3.5 w-3.5 mr-2 animate-spin" />
                    ) : (
