export const fieldInputClass =
  "h-12 bg-transparent border-border/60 hover:border-border focus:border-primary focus:ring-2 focus:ring-primary/15 rounded-lg transition-colors placeholder:text-muted-foreground/50 font-medium text-sm";
...
export const primaryButtonClass =
  "rounded-xl border-none bg-primary font-semibold text-primary-foreground shadow shadow-primary/20 hover:bg-primary/90 disabled:bg-muted disabled:text-muted-foreground disabled:shadow-none";
